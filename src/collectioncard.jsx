    ...
    <div className= "dtcs:h-[462px] dtdf:h-[500px] w-full flex flex-col dtcs:flex-row gap-[20px] dtcs:gap-[40px] items-center  justify-center absolute top-[254px] dtcs:top-[577px] ">
              ...
              <div className="flex flex-col dtcs:flex-row gap-[16px] relative dtcs:gap-[24px] dtcs:h-[462px] dtdf:h-[500px] ">
                    ...
                    <div className="w-[343px] h-[500px] dtcs:w-[382.5px] dtcs:h-full dtdf:w-[575px] relative bg-[url('/src/img/collection1.jpg')] bg-cover bg-center "> 
                          ...
                          {/* Gradient Overlay */}
                          <div className="h-[350px] absolute top-[150px] inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.8)] from-65% to-transparent dtcs:h-[277.2px] dtcs:top-[184.8px] dtcs:from-[rgba(0,0,0,0.8)] dtcs:from-0% dtcs:to-transparent dtdf:h-[300px] dtdf:top-[200px] dtdf:from-[rgba(0,0,0,0.8)] dtdf:from-0% dtdf:to-transparent ">
                          </div> 
                            {/* Content container */}
